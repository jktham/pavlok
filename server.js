...
app.get("/auth", function (req, res) {
    ...
    res.redirect(302, `https://pavlok-mvp.herokuapp.com/oauth/authorize?client_id=${client_id}&redirect_uri=http%3A%2F%2F127.0.0.1%3A3000%2Ftoken&response_type=code`);
});
